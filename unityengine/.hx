...
@:realPath("unityengine.Color") @:final @:csNative @:native("UnityEngine.Color") extern class Color extends System.ValueType {
	var a : Single;
	var b : Single;
	var g : Single;
	...
	@:final @:overload function get_gamma() : Color;
	@:final @:overload function get_grayscale() : Single;
	@:final @:overload function get_linear() : Color;
	...
	@:final @:overload static function get_black() : Color;
	@:final @:overload static function get_blue() : Color;
	@:final @:overload static function get_clear() : Color;
	@:final @:overload static function get_cyan() : Color;
	@:final @:overload static function get_gray() : Color;
	@:final @:overload static function get_green() : Color;
	@:final @:overload static function get_grey() : Color;
	@:final @:overload static function get_magenta() : Color;
	@:final @:overload static function get_red() : Color;
	@:final @:overload static function get_white() : Color;
	@:final @:overload static function get_yellow() : Color;
